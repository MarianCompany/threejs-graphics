...
import {createShaderSphere} from "./objects/shader-sphere.js";
...
const shaderSphere = createShaderSphere();
shaderSphere.position.set(0, 1, -3);
...
function animate() {
    ...
    if (shaderSphere.tick) shaderSphere.tick(delta);
